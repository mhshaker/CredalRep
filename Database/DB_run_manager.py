...
if(mode == "get"):
    mycursor.execute(f"SELECT id, runs FROM experiments Where status='pending' AND task='{var}' AND id>=5879")  # remove  "AND id>=4793" if you want to run old pending tasks
