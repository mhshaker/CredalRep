...
modes          = ["bays", "set19", "set18", "out"] # , "set14.convex"
task           = "unc"
runs           = 100
prams = {
# 'criterion'          : "entropy",
...
for algo in algos:
    for data_name in data_names:
        for mode in modes:
            run_name       = "CredalRepPaperUAI100" #f"{mode}_{algo}" + "noctua_test" # if you want a specific name give it here
